...
def generate_questions():
    ...
    quiz_description = ''
    if 'quiz_description_file' in quiz_data_from_file:
    ...
    for question in question_list:
        ...
        if question['question_type'] == 'static_multiple_choice':
            ...
            new_questions = multiple_choice_with_variables(question.get('points', 1),question['stem'],question['versions_requested'],question['override_duplicate_stem'],\
            ...
            new_questions = ordered_multiple_choice(question.get('points', 1),question['stem'],question['versions_requested'],question['override_duplicate_stem'],\
            ...
            new_questions = ranked_list_multiple_choice(question.get('points', 1),question['stem'],question['versions_requested'],question['override_duplicate_stem'],question['ranked_list_multiple_choice']['ranked_list'],question['ranked_list_multiple_choice']['answer_list_length'],question['ranked_list_multiple_choice']['num_correct'],question['ranked_list_multiple_choice']['force_multiple_choice'],question.get('image'))
        elif question['question_type'] == 'multiple_choice_matching':
            new_questions = multiple_choice_matching(question.get('points', 1),question['stem'],question['versions_requested'],question['override_duplicate_stem'],\
            ...
            new_questions = numeric_question(question.get('points', 1),question['stem'],question['versions_requested'],question['override_duplicate_stem'],\
            ...
            new_questions = multiple_answer(question.get('points', 1),question['stem'],question['versions_requested'],question['override_duplicate_stem'],\
            ...
            new_questions = transit_graph(question.get('points', 1),question['stem'],question['versions_requested'],question['override_duplicate_stem'],\
